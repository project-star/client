...
/**
 * UrlUI is the central store of state for the sidebar application,
...
var urlsReducer = require('./reducers/urls');
var selectionReducer = require('./reducers/urlselection');
...
module.exports = function ($rootScope, settings) {
  ...
  // `urlUI` service to make using them easier from app code. eg.
  //
  // Instead of:
  ...
  var selectors = util.bindSelectors({
    isUrlSelected: selectionReducer.isUrlSelected,
    hasSelectedUrls: selectionReducer.hasSelectedUrls,

    urlExists: urlsReducer.urlExists,
//    savedUrls: urlsReducer.savedUrls,
