 ...
 */
// @ngInject
function Datacollect($rootScope, annotationMapper, annotationUI, features, groups,
                  session, settings) {
...
//         socket.send("hello")
  ...
  var connectionsend = function (msg) {
    if (socket) {
      var toSend={}
      toSend.messageType = "metrics_data"
      toSend.eventName = msg
      socket.send(toSend);
    }
  };
